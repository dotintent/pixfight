...
public class PFGL2View extends GLSurfaceView {
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            PFGameLib.renderFrame();
        }

        public void onSurfaceChanged(GL10 gl, int width, int height) {

            if (callback != null) {
                callback.initalize(width, height);
            }
        ...
        private void initializeGame() {
            ...
            int playerSelected = gameBundle.getInt("playerID");
            int playersPlaying = gameBundle.getInt("players");
            String mapName = gameBundle.getString("mapname");
            String savePath = gameBundle.getString("savepath");

            if (savePath == null) {

                //start new game
                PFGameLib.nativeStartGame(mapName, playerSelected, playersPlaying);
            }
            else {

                //load game
                PFGameLib.nativeLoadGame(savePath);
            }
        }
    }
}
